...
regexp2 = r"Content-Length: (.*?)\r\n"
result2 = re.findall(regexp2, str_header, re.MULTILINE)
print(result)
if result and result[0] == "chunked":
    ...
    buf_body = b""
    len_body = int(result2[0], 10)
    buf_body += read_block(ssl_sk, len_body)
    print(buf_body.decode("utf-8"))
