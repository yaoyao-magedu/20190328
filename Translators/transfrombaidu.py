...
class BaiduTranslator(QObject):
    def __init__(self):
        super().__init__()
        # Request Head
        self.str_request = "POST /sug HTTP/1.1\r\n"
        self.str_request += "Host: fanyi.baidu.com\r\n"
        ...
        self.str_request += "\r\n"
        self.str_request += "kw={keyword}"

    def translate(self, kw):
        print("Start Translate Baidu", kw)
        ...
        # send request
        request = self.str_request.format(length=len(kw.encode())+3, keyword=kw)
